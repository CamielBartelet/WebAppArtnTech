...
box1.from(
  "#img3",
  { duration: 1, y: -400, opacity: 0, ease: "power2", scale: 0 },
  "-=4"
);
...
box1.from("#img5", { duration: 1, opacity: 0, ease: "back", scale: 0 });

box1.to(".box1", { duration: 1, x: -550, ease: "power1", scale: 1 });

// VOLGENDE

box2.from("#img6", { duration: 1, y: -250, ease: "back", scale: 0 }, "+=4")
